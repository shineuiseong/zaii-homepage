<template>
  <div class="prostate-section-nav">
    <div class="container prostate-section-nav__container">
      <div class="prostate-section-nav__viewport">
        <div
          ref="scrollRef"
          class="prostate-section-nav__scroll"
        ...
        >
          <button
            ...
            :key="item.id"
            type="button"
            class="prostate-section-nav__item"
...
const scrollActiveTabIntoView = () => {
  ...
  const activeButton = container.querySelector<HTMLElement>('.prostate-section-nav__item.is-active')
...
.prostate-section-nav__container {
  padding-left: 0;
  padding-right: 0;
}

.prostate-section-nav__viewport {
  position: relative;
}

.prostate-section-nav__scroll {
  display: flex;
  align-items: center;
